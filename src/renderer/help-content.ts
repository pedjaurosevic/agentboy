...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "F7", label: "WEAR", desc: "Cycle New → Worn → Cracked." },
      ...
      { key: "F10", label: "FLOAT", desc: "Free-floating window: leave the 3×2 snap grid, resize freely. (Compact: F4.)" },
      { key: "F11", label: "BOTTOM", desc: "Scroll the active pane to the bottom, like Ctrl+End. (Compact: F5.)" },
      { key: "F12", label: "EXPAND", desc: "With the tall column (B) active, expand over the toolbar and back. (Compact: F6.)" },
    ],
  },
  {
